...
class PageControllerTest extends WebTestCase
{
    ...
    public function testContact()
    {
      ...
      $form['blogger_blogbundle_enquirytype[body]']     = 'The comment body must be at lease 50 characters long as there is a validation constraint on the Enquiry entity.';
